...
def load_config(config_path: Path | None = None) -> AppConfig:
    ...
    screener = ScreenerConfig(
        ...
        min_history_rows=int(screener_raw.get("min_history_rows", 520)),
        pivot_k=int(screener_raw.get("pivot_k", 3)),
        cluster_tolerance=float(screener_raw.get("cluster_tolerance", 0.03)),
        touch_tolerance=float(screener_raw.get("touch_tolerance", 0.02)),
        min_touches=int(screener_raw.get("min_touches", 3)),
        min_touch_gap_weeks=int(screener_raw.get("min_touch_gap_weeks", 4)),
        min_span_weeks=int(screener_raw.get("min_span_weeks", 20)),
        ...
        max_buy_extension=float(screener_raw.get("max_buy_extension", 0.08)),
        ...
        min_amount=float(screener_raw.get("min_amount", 100_000_000)),
